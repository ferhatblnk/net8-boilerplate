...
{
    public class DailyCacheInterceptor : InterceptorBase<DailyCacheAttribute>
    {
        private readonly ICacheManager _cacheManager;
        private readonly IHttpContextAccessor _httpContext;

        public DailyCacheInterceptor()
        {
        ...
        private DailyCacheAttribute GetAttribute(MethodInfo methodInfo, Type type)
        {
            var attribute = methodInfo.GetCustomAttribute<DailyCacheAttribute>(true);
            if (attribute is not null)
                return attribute;
            return type.GetTypeInfo().GetCustomAttribute<DailyCacheAttribute>(true);
        }
    }
}
